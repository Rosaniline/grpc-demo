...
class Person(google___protobuf___message___Message):
    ...
    if sys.version_info >= (3,):
        def ClearField(self, field_name: typing_extensions___Literal[u"email",u"id",u"name"]) -> None: ...
    else:
        def ClearField(self, field_name: typing_extensions___Literal[b"email",b"id",b"name"]) -> None: ...
